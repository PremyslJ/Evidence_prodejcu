...
public class Main {
    public static void main(String[] args) {
        ...
        int pocetSmluv = 4;                           // pocet uzavrenych smluv
        double prodanaMrkev = 3.00;                  // celková prodaná mrkev
        ...
        System.out.println("Průměrné množství prodané mrkve v tunách na jednu smlouvu je  "+prumProdMrkev);
